...
def stochastic_grid_shapes(args):
  ...
  return list(zip(grid_widths, grid_heights, node_counts))
...
def calculate_grid_shapes(args):
  ...
  Each tuple is (width, height, node_count)
  '''
  shapes = []
...
if __name__ == "__main__":
  ...
  for ((width, height, node_count), (event_density, ring_size, time_to_run, small_payload, large_payload, large_event_fraction)) in parameters:
